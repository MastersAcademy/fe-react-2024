    ...
    <div className={aboutStyles.container}>
        ...
        <div className={aboutStyles.text}>
            ...
            <div className={aboutStyles.body1}>
                ...
                <p>
                    This page was developed during the course &apos;Intro to React&apos; from Masters Academy in 2024. This is a social
                    project from MOCG company where I got an opportunity to work with Frontend mentors and to create my own small project
                    for the portfolio.
                </p>
                <p>
